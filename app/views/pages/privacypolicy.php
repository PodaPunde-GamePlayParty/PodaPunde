...
<div class="container mt-3">
    <div class="d-inline">
        ...
        <p>GamePlayParty ("ons", "wij" of "onze") beheert de http://www.gameplayparties.nl website ("hierna genoemd Dienst").</p><br>
        ...
        <ul>
            <li>
                <p><strong>Dienst</strong></p>
                        <p>Onder dienst verstaan wij de http://www.gameplayparties.nl website beheerd door GamePlayParty</p>
                    </li>
            <li>
        ...
        <ul>
                <li>Via email: PodaPundee@gmail.com</li>
